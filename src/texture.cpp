...
Texture::Texture(Format format, std::string path) :
...
Texture::~Texture()
{
    ...
    std::cerr << "Delete texture" << std::endl;
...
{
    const char * imagepath = texturePath.c_str();
    ...
    std::cout << "glGenTextures -> " << textureID << std::endl;
...
{
    const char * imagepath = this->texturePath.c_str();
